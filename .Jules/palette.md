...
## 2025-02-23 - File Upload Keyboard Navigation
...
**Action:** Use `sr-only` on the input element to visually hide it while keeping it in the tab order, and apply `focus-within` styling to its wrapper (e.g., `<label>`) to show focus state visually.
