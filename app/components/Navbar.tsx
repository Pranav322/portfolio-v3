...
function FloatingDockDemo({
  ...
  // Memoize links array to prevent unnecessary re-renders of child Dock items
  const links = useMemo(
    () => [
      {
        title: 'Home',
    ...
    [] // No dependencies as state handlers use functional references without closure capture
  );
