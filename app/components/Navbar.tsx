...
function FloatingDockDemo({
  ...
  // ⚡ Bolt: Memoize links array to maintain referential equality across re-renders
  // This prevents unnecessary re-renders of the FloatingDock and its IconContainers
  const links = useMemo(
    () => [
      {
        title: 'Home',
