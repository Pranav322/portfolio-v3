...
function FloatingDockDemo({
  ...
  const links = [
    ...
    },
    {
      ...
      action: () => {
        ...
        setWindowKeys(prev => ({ ...prev, Settings: (prev['Settings'] || 0) + 1 }));
      },
    },
    // {
    //   title: 'Components',
    ...
    // },
    {
      ...
      action: () => {
        setShowGames(true);
        setWindowKeys(prev => ({ ...prev, Games: (prev['Games'] || 0) + 1 }));
      },
    },
    {
      title: 'Twitter',
  ...
  return (
    <>
      ...
      {showGames && (
        <GamesWindow onClose={() => setShowGames(false)} key={windowKeys['Games'] || 0} />
      )}
    </>
  );
}
