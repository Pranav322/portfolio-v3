...
const TerminalClock = React.memo(function TerminalClock() {
...
const TerminalCommandItem = React.memo(function TerminalCommandItem({ command, userName }: { command: TerminalCommand, userName: string }) {
  return (
    <div
