...
import { IconFolder, IconUser, IconTools, IconBriefcase, IconFileCode, IconBrandGithub, IconMail } from '@tabler/icons-react';
    ...
    <>
      <div className="fixed left-4 top-4 grid grid-cols-1 gap-6">
        {icons.map((icon, index) => (
          ...
          >
            <div className={`p-3 rounded-lg backdrop-blur-md bg-black/20 group-hover:bg-black/30 transition-all ${icon.color}`}>
              {icon.icon}
            </div>
