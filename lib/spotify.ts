...
// Performance optimization: In-memory Promise cache to prevent redundant concurrent requests
// when multiple UI components render and request Spotify data simultaneously.
...
async function getAccessToken() {
  ...
  tokenExpirationTime = 0; // pending state
  cachedTokenPromise = fetch(TOKEN_ENDPOINT, {
    ...
    .then(async response => {
      ...
      // expire 5 mins before actual expiration to be safe
