...
class RacingGame {
    ...
    handleInput() {
        ...
        // Move right
        if ((this.keys['arrowright'] || this.keys['d']) && this.player.x < this.canvas.width - this.player.width - 200) {
            this.player.x += this.player.speed;
        }
    ...
    spawnObjects() {
        ...
        if (this.powerUpSpawnTimer > 600) { // Less frequent than coins
            this.spawnPowerUp();
            this.powerUpSpawnTimer = 0;
        }
    }
    ...
    render() {
        ...
        this.powerUps.forEach(powerUp => {
            this.drawPowerUp(powerUp.x, powerUp.y, powerUp.width, powerUp.height, powerUp.type, powerUp.rotation);
        });
